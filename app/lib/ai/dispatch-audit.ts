...
export type ProviderAudit={id:string;workId?:string;mode:"dry_run"|"real";provider?:string;status:string;externalCallMade:boolean;paidUsageTriggered:boolean;externalCallUncertain?:boolean;error?:string;createdAt:string};
